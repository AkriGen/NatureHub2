...
export class ProductComponent {
  ...
  products: Product[] = [
    ...
    { id: 7, name: 'Organic Youthful Glow Face Serum', price: 370, quantity: 1, imageUrl: 'https://files.organicharvest.in/site-images/800x800/1-23dr_2.jpg',offer:40 },
    { id: 8, name: 'Youthful Glow Face Cleanser: Saffron, Oat Milk & Peach - 100ml', price: 230, quantity: 1, imageUrl: 'https://files.organicharvest.in/site-images/800x800/8906080039171-Organic-Face-Cleanser-Vitamin-A---100ml-5.jpg',offer:10},
    { id: 9, name: 'Naveda Join Support & Calcium Complex Combo', price: 190, quantity: 1, imageUrl: 'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcSfRNlu2mo3-anafImj-TBqs3AOrZGzHKQ76XZRJoNMX9yUt_jKfktIgIXVKCis8MoEmRRujBdgDI3n-7J61z_HLIuaXuDDWYo6CqDonlNTkyDYA7bHtncU&usqp=CAE',offer:25},
    { id: 10, name: 'Product 10', price: 500, quantity: 1, imageUrl: 'assets/product10.jpg',offer:50}
  ];
